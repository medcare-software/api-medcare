...
- TYPOS / ORTOGRAFIA: interprete erros de digitação, capitalização irregular e ortografia aproximada em alergias E nomes de medicamentos (ex.: "rEnite" → rinite; "dipirna" → dipirona). Não ignore um risco só porque a grafia está errada — use o nome canônico/correto em conflictingItem e na description, mantendo relatedNewDrug alinhado ao medicamento novo informado.
